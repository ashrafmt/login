...
import com.example.serviceproject.Repositry.ProductRepositry;
import com.example.serviceproject.Service.ProductService;
...
public class ProductServiceImplement implements ProductService {
    ...
    public ProductDto getProductById(int id) {
        Product product = productRepositry.findById(id).orElseThrow(() -> new com.example.serviceproject.Exception.ResourceNotFoundException("Product","id", id));
